...
<body class="font-sans antialiased md:h-screen  bg-no-repeat bg-gradient-to-tr from-bermuda via-white to-blue-100">
    @livewireScripts
    <x-dialog />
        ...
        <div class=" flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class=" hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a href="{{ route('user-dashboard') }}"  class="block py-2 px-3 text-yellow-500 uppercase font-bold  rounded md:bg-transparent  md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">Home</a>
              </li>
              <li>
                <a href="{{ route('leaderboard') }}"  class="block py-2 px-3 text-yellow-500 uppercase font-bold  rounded md:bg-transparent  md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">LeaderBoard</a>
              </li>
